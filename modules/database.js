...
exports.init = function (callback) {
    ...
    const createSpotifyPostsTableQuery = `CREATE TABLE IF NOT EXISTS ${config.get('spotify:table_name_post')} (id BIGINT UNSIGNED, PRIMARY KEY(id), user_id BIGINT UNSIGNED,  textcontent TEXT, detail_json LONGBLOB, updated TIMESTAMP default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP);`;
